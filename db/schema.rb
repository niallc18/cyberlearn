...
ActiveRecord::Schema.define(version: 2023_04_19_220519) do
  ...
  create_table "user_progressions", force: :cascade do |t|
    t.bigint "lesson_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["lesson_id"], name: "index_user_progressions_on_lesson_id"
    t.index ["user_id"], name: "index_user_progressions_on_user_id"
  end
